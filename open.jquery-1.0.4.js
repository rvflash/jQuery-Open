...
(function($)
{
    ...
    var getOpenUrl = function(elem, settings) {
        return _getCompleteUrl(elem, settings);
    };
    ...
    $.getOpenUrl = function(elem, settings) {
        return _getCompleteUrl(elem, settings);
    };

    $.openNode = function(elem, settings) {
        if (typeof(settings) === 'undefined') {
            settings = {};
        }
        var settings = $.extend({}, _defaults, settings);
        return open(elem, settings);
    };
